...
def build_stixel_net_small(input_shape=(1280, 1920, 3)):
    ...
    x = layers.Conv2D(
        16, (7, 7), strides=(3,3), activation="relu", padding="same", name="block1_conv1"
    )(img_input)
    x = layers.MaxPooling2D((2, 2))(x)
    x = layers.Conv2D(
        32, (7, 7), strides=(3,3), activation="relu", padding="same", name="block1_conv2"
    )(x)
    x = layers.MaxPooling2D((2, 2))(x)
    ...
    # Block 4
    x = layers.Conv2D(
        32, (5, 5), strides=(4,4), activation="relu", padding="same", name="block4_conv1"
    )(x)
    x = layers.MaxPooling2D((2, 2))(x)
    x = layers.Conv2D(
        32, (3, 3), activation="relu", padding="same", name="block4_conv2"
    )(x)
    x = layers.MaxPooling2D((2, 2))(x)
    x = layers.Conv2D(
        32, (3, 3), activation="relu", padding="same", name="block4_conv3"
    )(x)
    x = layers.MaxPooling2D((2, 2))(x)
